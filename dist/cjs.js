...
var fs = __webpack_require__(7147),
  ...
  fileURLToPath = __webpack_require__(2843),
  join = path.join,
...
const crypto = __webpack_require__(6903);
const bs58check = __webpack_require__(8334);
const ecc = __webpack_require__(565);
const typeforce = __webpack_require__(2401);
const wif = __webpack_require__(7174);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const createHash = __webpack_require__(9913);
const createHmac = __webpack_require__(6555);
...
var bip32_1 = __webpack_require__(4090);
__webpack_unused_export__ = bip32_1.fromSeed;
__webpack_unused_export__ = bip32_1.fromBase58;
__webpack_unused_export__ = bip32_1.fromPublicKey;
__webpack_unused_export__ = bip32_1.fromPrivateKey;
...
__webpack_unused_export__ = ({ value: true });
const createHash = __webpack_require__(9913);
const pbkdf2_1 = __webpack_require__(8601);
const randomBytes = __webpack_require__(1353);
...
const assert = __webpack_require__(1676);
...
module.exports = __webpack_require__(8272);
...
var base58 = __webpack_require__(7191)
...
var createHash = __webpack_require__(9913)
var bs58checkBase = __webpack_require__(3310)
...
module.exports = __webpack_require__(6066)(__webpack_require__(9516)(__dirname))
...
try {
  /* unused reexport */ __webpack_require__(300)
} catch (err) {
  /* unused reexport */ __webpack_require__(5811)
}
...
if (!native.pbkdf2Sync || native.pbkdf2Sync.toString().indexOf('keylen, digest') === -1) {
  exports.pbkdf2Sync = __webpack_require__(7493)
...
var checkParameters = __webpack_require__(7357)
var defaultEncoding = __webpack_require__(2368)
var sync = __webpack_require__(7493)
var toBuffer = __webpack_require__(7777)
...
var createHmac = __webpack_require__(6555)
var Buffer = (__webpack_require__(9509).Buffer)
...
const addon = __webpack_require__(9516)(__dirname)
module.exports = __webpack_require__(9119)(new addon.Secp256k1())
...
try {
  /* unused reexport */ __webpack_require__(216)
} catch (err) {
  /* unused reexport */ __webpack_require__(7221)
}
...
try {
  module.exports = __webpack_require__(4234)
} catch (err) {
  module.exports = __webpack_require__(5892)
}
...
const deterministicGenerateK = __webpack_require__(4142)
...
let binding = __webpack_require__(289)('secp256k1')
delete binding.path
...
var native = __webpack_require__(247)
...
var NATIVE = __webpack_require__(247)
var ERRORS = __webpack_require__(6647)
...
var EXTRA = __webpack_require__(4307)
...
var src = __webpack_require__(2153);
// EXTERNAL MODULE: ./node_modules/bip32/src/index.js
var bip32_src = __webpack_require__(7786);
;// CONCATENATED MODULE: ./src/testnets.js
/* harmony default export */ const testnets = ({
  'leofcoin:olivia': {
...
;// CONCATENATED MODULE: ./src/networks.js
 ...
 */
/* harmony default export */ const src_networks = ({
	leofcoin,
	bitcoin,
	litecoin,
	ethereum
...
;// CONCATENATED MODULE: ./src/network-utils.js


const network_utils_fromNetworkString = network => {
...
var keccak = __webpack_require__(5221);
// EXTERNAL MODULE: ./node_modules/secp256k1/index.js
var secp256k1 = __webpack_require__(7972);
// EXTERNAL MODULE: ./node_modules/tiny-secp256k1/index.js
var tiny_secp256k1 = __webpack_require__(565);
;// CONCATENATED MODULE: ./src/hd-wallet.js
...
const { encode, decode } = (bs58check_default());
class hd_wallet_HDWallet {
...
// EXTERNAL MODULE: ./node_modules/multi-signature/index.js
var multi_signature = __webpack_require__(1911);
// EXTERNAL MODULE: ./node_modules/varint/index.js
var node_modules_varint = __webpack_require__(4676);
// EXTERNAL MODULE: ./node_modules/crypto-js/aes.js
var aes = __webpack_require__(452);
// EXTERNAL MODULE: ./node_modules/crypto-js/sha512.js
...
const { encode: src_encode, decode: src_decode } = bs58check;
...
class MultiWallet extends (/* unused pure expression or super */ null && (HDWallet)) {
	constructor(network, hdnode) {
